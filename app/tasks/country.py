...
def merge():
    ...
    for item in country_flags:
        ...
        if data is not None:
            data.update(dict(flag=item['flag'], local_name=item['name']))
...
def dump_json(ctx):
    ...
    check()
    int_number()
    _= json.dumps(country_list_iso_data, ensure_ascii=False, indent=4)
    print(_)
...
def dump_yaml(ctx):
    ...
    int_number()
    # encoding='utf-8'
    _ = yaml.safe_dump(country_list_iso_data, encoding=None, allow_unicode=True)
    print(_)
